...
mlflow.set_tracking_uri("http://ec2-52-77-219-79.ap-southeast-1.compute.amazonaws.com:5000/")

@pytest.mark.parametrize("model_name, stage, holdout_data_path, vectorizer_path", [
    ("my_model1", "staging", "data/interim/test_processed.csv", "tfidf_vectorizer.pkl"),  # Replace with your actual paths
])
